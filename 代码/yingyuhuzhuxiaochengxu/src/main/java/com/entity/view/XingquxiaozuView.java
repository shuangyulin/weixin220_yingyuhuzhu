...
public class XingquxiaozuView extends XingquxiaozuEntity implements Serializable {
	...
	public XingquxiaozuView() {

	}

	public XingquxiaozuView(XingquxiaozuEntity xingquxiaozuEntity) {
		try {
			BeanUtils.copyProperties(this, xingquxiaozuEntity);
