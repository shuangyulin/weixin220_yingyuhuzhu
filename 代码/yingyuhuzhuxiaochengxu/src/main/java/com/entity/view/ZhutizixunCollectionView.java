...
public class ZhutizixunCollectionView extends ZhutizixunCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String zhutizixunCollectionValue;
	...
	public ZhutizixunCollectionView() {

	}

	public ZhutizixunCollectionView(ZhutizixunCollectionEntity zhutizixunCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, zhutizixunCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getZhutizixunCollectionValue() {
				return zhutizixunCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setZhutizixunCollectionValue(String zhutizixunCollectionValue) {
				this.zhutizixunCollectionValue = zhutizixunCollectionValue;
			}
