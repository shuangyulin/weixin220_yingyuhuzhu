...
public class XingquxiaozuLiuyanView extends XingquxiaozuLiuyanEntity implements Serializable {
	...
	public XingquxiaozuLiuyanView() {

	}

	public XingquxiaozuLiuyanView(XingquxiaozuLiuyanEntity xingquxiaozuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, xingquxiaozuLiuyanEntity);
