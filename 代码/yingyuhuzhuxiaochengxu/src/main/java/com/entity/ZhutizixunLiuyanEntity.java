...
public class ZhutizixunLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhutizixunLiuyanEntity() {

	}

	public ZhutizixunLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "ZhutizixunLiuyan{" +
            "id=" + id +
            ", zhutizixunId=" + zhutizixunId +
            ", yonghuId=" + yonghuId +
            ", zhutizixunLiuyanText=" + zhutizixunLiuyanText +
