 ...
 * @email
 */
@TableName("xingquxiaozu_liuyan")
public class XingquxiaozuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XingquxiaozuLiuyanEntity() {

	}

	public XingquxiaozuLiuyanEntity(T t) {
		try {
     ...
     * 兴趣小组
     */
    @TableField(value = "xingquxiaozu_id")
     ...
     * 小组打卡内容
     */
    @TableField(value = "xingquxiaozu_liuyan_text")
    ...
    public String toString() {
        return "XingquxiaozuLiuyan{" +
            "id=" + id +
            ", xingquxiaozuId=" + xingquxiaozuId +
            ", yonghuId=" + yonghuId +
            ", xingquxiaozuLiuyanText=" + xingquxiaozuLiuyanText +
